...
class _editPageState extends State<editPage> with TickerProviderStateMixin {
  ...
  /*Future<void> updateTask(String id) async {
    ...
    final descriptionText = descriptionController.text == ''
        ? widget.todoItem!.todoDescription! + "*" + selectedPriority.toString()
        : descriptionController.text + "*" + selectedPriority.toString();
    if (titleController.text == widget.todoItem!.todoTitle &&
        descriptionController.text == widget.todoItem!.todoDescription) {
