      ...
      body: AnimatedBackground(
        behaviour: RandomParticleBehaviour(
          options: ParticleOptions(
            spawnMaxRadius: 25,
            spawnMinSpeed: 5.00,
            particleCount: toDoSettingsPageCheckedValue ? 50 : 0,
            minOpacity: 0.1,
            spawnOpacity: 0.2,
              ...
              Container(
                ...
                child: Row(
                  children: [
                    Text(
                      "Animation " +
                          (toDoSettingsPageCheckedValue ? "On" : "Off"),
                      style: TextStyle(
                          fontSize: 15,
                          fontWeight: FontWeight.w500,
                    ...
                    Checkbox(
                      value: toDoSettingsPageCheckedValue,
                      onChanged: (bool? newValue) {
                        setState(() {
                          toDoSettingsPageCheckedValue = newValue!;
                        });
                      },
                    ),
                  ],
